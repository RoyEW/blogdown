...
```{r}
 tribble(
  ...
  "2021", "Blogdown site written in R markdown", "Example of dynamicly produced articles and a resource to keep track of useful code", "RoyWilson.UK",
    "2020", "Dashboard web application written in R shiny", "Calculates the thermal expansion of High Entropy Alloys (HEAs) using the rule of mixtures approach", "RoyWilson.UK/HEA/",
