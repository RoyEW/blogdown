...
tribble(
  ~ Degree, ~ Year, ~ Institution, ~ Where,
    "Finance and Operations Assistant", "2021-Present", "Medical Resource Partners","
  ",
  
  "Sales assistant", "2016-Present", "ASDA Stores Ltd.","• Provide excellent customer service
...
```{r}
 tribble(
  ...
  "2021", "R markdown blogdown site", "Example of dynamically produced articles and a resource to keep track of useful code", "https://RoyWilson.UK",
    "2020", "R Shiny dashboard web application", "Calculates the thermal expansion of high entropy alloys using the rule of mixtures approach", "https://Alloys.one",
