...
```{r}
 tribble(
  ...
  "2021", "R markdown blogdown site", "Example of dynamically produced articles and a resource to keep track of useful code", "www.RoyWilson.UK",
    "2020", "R Shiny dashboard web application", "Calculates the thermal expansion of high entropy alloys using the rule of mixtures approach", "www.Alloys.one",
