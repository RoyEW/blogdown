...
tribble(
  ...
  • Built a shift management system with RShiny and PostgreSQL hosted on AWS, integrating with our CRM and payroll workflows. 
...
tribble(
  ~ Degree, ~ Year, ~ Institution, ~ Where,
  "Associate Member, Chartered Institute of Management Accountants", "", "AICPA & CIMA", "",
  
    "CGMA Advanced Diploma in Management Accounting","2025", "AICPA & CIMA","",
...
```{r}
 tribble(
   ...
   "2025", "R Shiny dashboard web application hosted on AWS", 'Molten salts research tools and database in collaboration with the General Atomics Center for Transformational Nuclear Technologies of University of South Carolina.  ', "https://moltsa.com",
