...
address: "Bangor, open to relocation"
 ...
 * Special interests in R statistical programming, data analysis and visualisation.
...
```{r}
 tribble(
  ...
  "2021", "R markdown blogdown site", "Example of dynamically produced articles and a resource to keep track of useful code", "RoyWilson.UK",
    "2020", "R Shiny dashboard web application", "Calculates the thermal expansion of high entropy alloys using the rule of mixtures approach", "RoyWilson.UK/HEA/",
...
```{r}
 tribble(
   ~ Degree, ~ Year, ~ Institution, ~ Where,
"","Welsh learner","• Learning Welsh to communicate with other learners and colleagues

• Enjoyed engaging with the ysgol haf, and Ffrind Cymraeg project","",
...
"","Financial econometrics and financial modelling","Making sense of financial markets through reading the Journal of Financial Econometrics","",
