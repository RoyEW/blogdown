...
# The InformationValue::optimalCutoff function predicts a better rounding of probability. This may be more accurate than siimply rounding to the nearest integer.  
...
```
The model has a misclassification rate of `r misClassError(confusion_matrix$output, confusion_matrix$prediction) * 100`% which is actually reasonably low for a classification model. 
