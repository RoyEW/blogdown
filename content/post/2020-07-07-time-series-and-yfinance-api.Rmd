...
data %>% 
   ggplot()+
   geom_rect(data=states,aes(fill=market_state, alpha=market_state,xmin=date-14,ymin=-Inf,xmax=date+7,ymax=Inf),alpha=0.04)+
  scale_color_manual(values = c("white","red", "green"),aesthetics = c("fill"))+
  geom_step(aes(date, percentage_price, colour = ticker))+
  geom_hline(yintercept = 0)+
  #geom_smooth(aes(date, percentage_price, colour = ticker),se = F)+
...
tsla %>% 
   ggplot()+
   geom_rect(data=tsla_states,aes(fill=market_state,xmin=date-14,ymin=-Inf,xmax=date+7,ymax=Inf),alpha=0.04)+
  scale_color_manual(values = c("white","red", "green"),aesthetics = c("fill"))+
  geom_step(aes(date, percentage_price, colour = ticker))+
   theme_bw()+
  geom_hline(yintercept = 0)+
