...
tsla %>% 
  mutate(is_tesla=ifelse(ticker=="TSLA",1,0)) %>% 
   ggplot()+
   geom_rect(data=tsla_states,aes(fill=market_state,xmin=date-1,ymin=ifelse(market_state=="+",0,tsla_states$percentage_price),xmax=date,ymax=ifelse(market_state=="+",tsla_states$percentage_price,0)),alpha=0.2)+
