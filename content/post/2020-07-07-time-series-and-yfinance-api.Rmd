...
eps <- extract_eps("Decompositions\\Raw income statements\\Ferrari.xls") %>% 
  union_all(extract_eps("Decompositions\\Raw income statements\\Fiat Chrysler.xls"))
eps
```
