...
tsla %>% 
  ...
  geom_line(aes(date, percentage_price, colour = ticker))+
...
data %>% 
   ggplot()+
   geom_rect(data=states,aes(fill=market_state, alpha=market_state,xmin=date-14,ymin=-Inf,xmax=date+7,ymax=Inf),alpha=0.08)+
  scale_color_manual(values = c("white","red", "green"),aesthetics = c("fill"))+
  geom_line(aes(date, percentage_price, colour = ticker))+
  geom_hline(yintercept = 0)+
  #geom_smooth(aes(date, percentage_price, colour = ticker),se = F)+
...
tsla %>% 
   ggplot()+
   geom_rect(data=tsla_states,aes(fill=market_state,xmin=date-14,ymin=-Inf,xmax=date+7,ymax=Inf),alpha=0.08)+
  scale_color_manual(values = c("white","red", "green"),aesthetics = c("fill"))+
  geom_line(aes(date, percentage_price, colour = ticker))+
  #geom_smooth(aes(date, percentage_price, colour = ticker),se = F)+
  #geom_smooth(colour = "black", lty = 2, aes(date, percentage_price), se = F)+
