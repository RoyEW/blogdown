...
# Conclusion
The speed gains in calculating the 30th iteration of the Fibonacci sequence within C++ (`r last_elapsed_c` seconds) massively outperforms R (`r last_elapsed_r` seconds).
