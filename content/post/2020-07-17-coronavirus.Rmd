...
Creating datasets specific to G8 and G20 nations.
...
covid_g20 %>% 
  ...
  #geom_hline(inherit.aes = F, data = covid_rates,aes(yintercept = Cumulative_number_for_14_days_of_COVID.19_cases_per_100000))+
  #geom_text_repel(inherit.aes = F, data = covid_rates, aes(label = countriesAndTerritories, y=Cumulative_number_for_14_days_of_COVID.19_cases_per_100000, x=today()))
